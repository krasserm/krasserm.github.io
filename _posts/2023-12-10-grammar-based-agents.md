...
This two-phase approach of unconstrained reasoning and constrained tool call generation may also be the basis for using more specialized models e.g. one for the reasoning phase and another one for the tool call phase. I plan to implement extensions with more specialized open LLMs in another experiment.
