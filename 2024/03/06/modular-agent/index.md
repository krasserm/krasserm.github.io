...
This decomposition of an agent into highly specialized modules is shown on the right side of Figure 1 and further described in section Modules. The implementation used in this article makes heavy use of [schema-guided generation](https://krasserm.github.io/2023/12/18/llm-json-mode/index.md). This ensures that the output generated by LLM-based modules follow an application-defined schema which makes communication between modules more reliable.

![agents](https://krasserm.github.io/img/2024-03-06/agent-approaches.png)
...
A tool that generates a final answer to the original request using all previous task-observation pairs ([code](https://github.com/krasserm/bot-with-plan/blob/wip-article-2/gba/tools/respond.py), sample [prompt](https://krasserm.github.io/docs/2024-03-06/response_prompt.txt) and [completion](https://krasserm.github.io/docs/2024-03-06/response_completion.txt)). This tool uses a zero-shot prompted Mistral-7B-Instruct-v0.2 model for generating the answer.
