...
- Development of a [service framework for operation-based CRDTs](https://krasserm.github.io/2016/10/19/operation-based-crdt-framework/).
...
- Usage of [Eventuate](https://rbmhtechnology.github.io/eventuate/) as technical basis for the web application backend. 
...
- [akka-stream-eventsourcing](https://github.com/krasserm/akka-stream-eventsourcing). A project that brings to Akka 
...
- [Apache Camel](http://camel.apache.org/). An integration framework based on Enterprise Integration Patterns. 
