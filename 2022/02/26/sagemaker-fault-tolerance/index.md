...
In a [previous article](https://krasserm.github.io/2022/01/21/sagemaker-multi-node/index.md) I introduced distributed training with PyTorch Lightning on 
...
application from the [previous article](https://krasserm.github.io/2022/01/21/sagemaker-multi-node/index.md). The implementation can be easily reused for 
...
![train-loss](https://krasserm.github.io/img/2022-02-26/train-loss.png)
![val-loss](https://krasserm.github.io/img/2022-02-26/val-loss.png)
