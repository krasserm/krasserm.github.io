...
This article gives an introduction to Gaussian processes for classification and provides a minimal implementation with NumPy. Gaussian processes for regression are covered in a [previous article](https://krasserm.github.io/2018/03/19/gaussian-processes/index.md) and a brief recap is given in the next section.
...
In contrast to the notation in the [previous article](https://krasserm.github.io/2018/03/19/gaussian-processes/index.md), I'm using here a single test input $\mathbf{x}_*$ to be consistent with the notation in the following sections. However, the implementation further below is vectorized so that predictions can be made for multiple test inputs $\mathbf{X}_*$ in a single operation.
...
![png](https://krasserm.github.io/img/2020-11-04/output_5_0.png)
    


### Training

As in [Gaussian processes](https://krasserm.github.io/2018/03/19/gaussian-processes/index.md) for regression, we again use a squared exponential kernel with length parameter `theta[0]` and multiplicative constant `theta[1]`.
...
![png](https://krasserm.github.io/img/2020-11-04/output_20_0.png)
...
![png](https://krasserm.github.io/img/2020-11-04/output_22_0.png)
...
![png](https://krasserm.github.io/img/2020-11-04/output_26_0.png)
...
![png](https://krasserm.github.io/img/2020-11-04/output_28_0.png)
...
![png](https://krasserm.github.io/img/2020-11-04/output_35_0.png)
...
![png](https://krasserm.github.io/img/2020-11-04/output_37_0.png)
...
![png](https://krasserm.github.io/img/2020-11-04/output_39_0.png)
