...
**There is also [companion notebook](http://nbviewer.jupyter.org/github/krasserm/face-recognition/blob/master/face-recognition.ipynb?flush_cache=true) for this article on [Github](https://github.com/krasserm/face-recognition).**
